  ...
  return (
    ...
    >
      <div className="max-w-[1200px] w-full mx-auto px-4 py-3 flex items-center justify-between rounded-3xl border border-[#197686] bg-[rgba(5,37,44,0.40)] backdrop-blur-[2px]">
        ...
        <Link
          href="/my-tickets"
          className="flex items-center gap-2 py-4 px-6 uppercase font-normal text-base leading-5 rounded-xl bg-white border border-[rgba(213,234,0,0.10)] text-[#0A0C11] jeju hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#197686] transition-colors"
